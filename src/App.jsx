...
function App() {
  ...
  return (
    <div
      className={`flex flex-col justify-center items-center gap-3 w-screen h-screen bg-green-50`}
    >
      <img
        className="w-screen h-screen absolute blur-lg opacity-80"
        src={randomSky}
        alt=""
      />
      ...
      <div className=" text-lg rounded-xl drop-shadow-lg bg-opacity-50 bg-white p-6 text-gray-600 w-2/5">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <h2 className="text-3xl font-bold text-cente">
              {weatherData.name}
            </h2>
          </div>
        ) : (
